REM Experiment 1:
@REM python .\reproduce\plot_results.py -o .\reproduce\my_results\experimento1 -ltx -op -f one-shot,dynamic-iterative -plt acc_drop
@REM python .\reproduce\plot_results.py -o .\reproduce\my_results\experimento1 -ltx -op -f one-shot,dynamic-iterative -plt speed_up
@REM python .\reproduce\plot_results.py -o .\reproduce\my_results\experimento1 -ltx -op -f one-shot,dynamic-iterative -plt acc_drop,speed_up
@REM python .\reproduce\plot_results.py -o .\reproduce\my_results\experimento1 -ltx -op -f one-shot,dynamic-iterative -plt runtime
@REM python .\reproduce\plot_results.py -o .\reproduce\my_results\experimento1 -ltx -op -f one-shot,dynamic-iterative -plt runtime,speed_up
